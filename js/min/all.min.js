...
$(document).ready(function(){function t(t){var e={areas:{},plots:{}},a=[],o={},n="";$.each(t,function(t,e){var a="";$.each(e.artworks,function(t,e){a+="<li>"+e.code+"</li>"}),o[e.code]={type:"circle",size:20,latitude:e.lat,longitude:e["long"],attrs:{fill:"#2056a4"},text:{content:e.id,position:"inner",attrs:{"font-size":14,"font-weight":"bold",fill:"#fff"}},eventHandlers:{"click touchstart":function(t,o,n,i,l){$("#clickContent").html("<div id='testcontent'><h2><a href='/location/"+e.id+"'>[ "+e.id+" ] "+e.code+"</a></h2><a href='#' class='closeBtn'></a><ul>"+a+"</ul></div>")}}},n+="<li><h3><img src='images/loc"+e.id+"_bl.png' alt='number'/>"+e.code+"</h3><p>"+e.address_nl+"</p></li>",$("#locaties_list").html("<ul>"+n+"</ul>")}),$(".mapcontainer").trigger("update",[e,o,a,{animDuration:1e3}])}function e(t,e){var a={areas:{},plots:{}},o=["user"],n={user:{type:"image",url:"images/user_icon.svg",width:10,height:25,latitude:t,longitude:e,text:{content:""}}};$(".mapcontainer").trigger("update",[a,n,o,{animDuration:1e3}]),l||(l=!0,$(".mapcontainer").trigger("zoom",{level:10,latitude:t,longitude:e}))}function a(t){var a=t.coords.latitude,o=t.coords.longitude;e(a,o),i(a,51.0288,o,4.479)}function o(){navigator.geolocation?navigator.geolocation.watchPosition(a,function(t){console.log(t)},{enableHighAccuracy:!0}):alert("Geolocation is not supported by this browser.")}function n(t){return t*Math.PI/180}function i(t,e,a,o){var i=6371e3,l=n(e-t),r=n(o-a),c=Math.sin(l/2)*Math.sin(l/2)+Math.cos(n(t))*Math.cos(n(e))*Math.sin(r/2)*Math.sin(r/2),s=2*Math.atan2(Math.sqrt(c),Math.sqrt(1-c)),u=i*s;console.log(u)}console.log("Version 0.5.1");var l=!1;if($(".mapcontainer").mapael({map:{name:"mechelen",zoom:{enabled:!0,maxLevel:10,mousewheel:!0}},areas:{groen:{attrs:{fill:"#129764"}},water:{attrs:{fill:"#6283c2"}},straat:{attrs:{fill:"#fff"}},straatnaam:{attrs:{fill:"#666666"}},parkwaternaam:{attrs:{fill:"#fff"}}}}),"undefined"!=typeof Storage)if(null===localStorage.getItem("jsondata"))window.location="/";else{var r=JSON.parse(localStorage.getItem("jsondata"));console.log(r),t(r)}else alert("Could not be cached");$("#clickContent").on("click","a.closeBtn",function(t){return $("#clickContent").html(""),!1}),o()});