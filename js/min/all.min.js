...
$(document).ready(function(){function t(t){var a={areas:{},plots:{}},i=[],e={},s="",n="";$.each(t,function(t,a){var i="";$.each(a.artworks,function(t,a){i+="<li>"+a.code+"</li>"}),e[a.code]={type:"circle",size:20,latitude:a.lat,longitude:a["long"],attrs:{fill:"#2056a4"},text:{content:a.id,position:"inner",attrs:{"font-size":14,"font-weight":"bold",fill:"#fff"}},eventHandlers:{"click touchstart":function(t,e,s,n,o){$("#clickContent").html("<div id='testcontent'><h2><a href='/location/"+a.id+"'>[ "+a.id+" ] "+a.code+"</a></h2><a href='#' class='closeBtn'></a><ul>"+i+"</ul></div>")}}},s+="<li class='locaties_item'><img src='images/loc"+a.id+"_bl.png' alt='number'/><h3>"+a.code+"</h3><p id='idselect'>"+a.id+"</p></li>",$("#locaties_list").html("<ul>"+s+"</ul>"),$(".locaties_item").on("mouseover",function(){$(this).css({"background-color":"#2056A4",color:"white"}),$(this).css({"background-image":"url(images/arrowright_w.png)"});var t=$(this).find("img").attr("src");switch(t){case"images/loc1_bl.png":$(this).find("img").attr("src","images/loc1.png");break;case"images/loc2_bl.png":$(this).find("img").attr("src","images/loc2.png");break;case"images/loc3_bl.png":$(this).find("img").attr("src","images/loc3.png");break;case"images/loc4_bl.png":$(this).find("img").attr("src","images/loc4.png");break;case"images/loc5_bl.png":$(this).find("img").attr("src","images/loc5.png");break;case"images/loc6_bl.png":$(this).find("img").attr("src","images/loc6.png");break;case"images/loc7_bl.png":$(this).find("img").attr("src","images/loc7.png");break;case"images/loc8_bl.png":$(this).find("img").attr("src","images/loc8.png")}}),$(".locaties_item").on("mouseout",function(){$(this).css({"background-color":"#fff",color:"#2056A4"}),$(this).css({"background-image":"url(images/arrowright.png)"});var t=$(this).find("img").attr("src");switch(t){case"images/loc1.png":$(this).find("img").attr("src","images/loc1_bl.png");break;case"images/loc2.png":$(this).find("img").attr("src","images/loc2_bl.png");break;case"images/loc3.png":$(this).find("img").attr("src","images/loc3_bl.png");break;case"images/loc4.png":$(this).find("img").attr("src","images/loc4_bl.png");break;case"images/loc5.png":$(this).find("img").attr("src","images/loc5_bl.png");break;case"images/loc6.png":$(this).find("img").attr("src","images/loc6_bl.png");break;case"images/loc7.png":$(this).find("img").attr("src","images/loc7_bl.png");break;case"images/loc8.png":$(this).find("img").attr("src","images/loc8_bl.png")}})});var o=t[1],c=o.name_nl,l=o.address_nl,r=o.description_nl;o.image;$(".locatie_header h2").html(c),console.log(t[0].code),$("#adres").html(l),$("#beschrijving").html(r),$.each(o.artworks,function(t,a){n+="<li><img src='"+a.image+"'><div><h3>"+a.name_nl+"</h3><p>"+a.artist.name+"</p></div></li>"}),$(".art_lists").html("<ul>"+n+"</ul>"),$(".mapcontainer").trigger("update",[a,e,i,{animDuration:1e3}])}function a(t,a){var i={areas:{},plots:{}},e=["user"],s={user:{type:"image",url:"images/user_icon.svg",width:10,height:25,latitude:t,longitude:a,text:{content:""}}};$(".mapcontainer").trigger("update",[i,s,e,{animDuration:1e3}]),o||(o=!0,$(".mapcontainer").trigger("zoom",{level:10,latitude:t,longitude:a}))}function i(t){var i=t.coords.latitude,e=t.coords.longitude;a(i,e),n(i,51.0288,e,4.479)}function e(){navigator.geolocation?navigator.geolocation.watchPosition(i,function(t){console.log(t)},{enableHighAccuracy:!0}):alert("Geolocation is not supported by this browser.")}function s(t){return t*Math.PI/180}function n(t,a,i,e){var n=6371e3,o=s(a-t),c=s(e-i),l=Math.sin(o/2)*Math.sin(o/2)+Math.cos(s(t))*Math.cos(s(a))*Math.sin(c/2)*Math.sin(c/2),r=2*Math.atan2(Math.sqrt(l),Math.sqrt(1-l)),g=n*r;console.log(g)}console.log("Version 0.5.1");var o=!1;if($(".mapcontainer").mapael({map:{name:"mechelen",zoom:{enabled:!0,maxLevel:10,mousewheel:!0}},areas:{groen:{attrs:{fill:"#129764"}},water:{attrs:{fill:"#6283c2"}},straat:{attrs:{fill:"#fff"}},straatnaam:{attrs:{fill:"#666666"}},parkwaternaam:{attrs:{fill:"#fff"}}}}),"undefined"!=typeof Storage)if(null===localStorage.getItem("jsondata"))window.location="/";else{var c=JSON.parse(localStorage.getItem("jsondata"));console.log(c),t(c)}else alert("Could not be cached");$("#clickContent").on("click","a.closeBtn",function(t){return $("#clickContent").html(""),!1}),e()});