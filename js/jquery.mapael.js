	...
	$.fn.mapael = function(options) {
		...
		return this.each(function() {
			...
			*/
            ...
            options.map.zoom.enabled && mc.on('pinchin', function(e) {
                $parentContainer.trigger("zoom", {"level" : $parentContainer.data("zoomLevel") - 0.25});
    
                return false;
            });
            options.map.zoom.enabled && mc.on('pinchout', function(e) {
                $parentContainer.trigger("zoom", {"level" : $parentContainer.data("zoomLevel") + 0.25});
